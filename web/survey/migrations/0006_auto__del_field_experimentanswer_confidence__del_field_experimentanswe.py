...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExperimentAnswer.confidence'
        db.delete_column(u'survey_experimentanswer', 'confidence')

        # Deleting field 'ExperimentAnswerProcessed.bias'
        db.delete_column(u'survey_experimentanswerprocessed', 'bias')

        # Deleting field 'ExperimentAnswerProcessed.error'
        db.delete_column(u'survey_experimentanswerprocessed', 'error')


    def backwards(self, orm):
        # Adding field 'ExperimentAnswer.confidence'
        db.add_column(u'survey_experimentanswer', 'confidence',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnswerProcessed.bias'
        db.add_column(u'survey_experimentanswerprocessed', 'bias',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=19, decimal_places=10),
                      keep_default=False)

        # Adding field 'ExperimentAnswerProcessed.error'
        db.add_column(u'survey_experimentanswerprocessed', 'error',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=19, decimal_places=10),
                      keep_default=False)
