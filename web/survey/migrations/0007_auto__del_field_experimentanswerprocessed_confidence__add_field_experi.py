...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExperimentAnswerProcessed.confidence'
        db.delete_column(u'survey_experimentanswerprocessed', 'confidence')

        # Adding field 'ExperimentAnswerProcessed.screen_h'
        db.add_column(u'survey_experimentanswerprocessed', 'screen_h',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ExperimentAnswerProcessed.screen_w'
        db.add_column(u'survey_experimentanswerprocessed', 'screen_w',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExperimentAnswerProcessed.confidence'
        db.add_column(u'survey_experimentanswerprocessed', 'confidence',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ExperimentAnswerProcessed.screen_h'
        db.delete_column(u'survey_experimentanswerprocessed', 'screen_h')

        # Deleting field 'ExperimentAnswerProcessed.screen_w'
        db.delete_column(u'survey_experimentanswerprocessed', 'screen_w')
    ...
    models = {
        ...
        u'survey.experimentanswerprocessed': {
            ...
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Question']"}),
            'screen_h': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'screen_w': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
