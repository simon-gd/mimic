# This file is generated by D:\Dev\Compile\scipy\scipy-0.12.x-git\setup.py
# It contains system_info results at the time of building this package.
__all__ = ["get_info","show"]

amd_info={'libraries': ['amd'], 'library_dirs': ['X:\\inclib-vc9-x32'], 'swig_opts': ['-IX:\\inclib-vc9-x32'], 'define_macros': [('SCIPY_AMD_H', None)], 'include_dirs': ['X:\\inclib-vc9-x32']}
...
umfpack_info={'libraries': ['umfpack', 'amd'], 'library_dirs': ['X:\\inclib-vc9-x32'], 'swig_opts': ['-IX:\\inclib-vc9-x32\\umfpack', '-IX:\\inclib-vc9-x32'], 'define_macros': [('SCIPY_UMFPACK_H', None), ('SCIPY_AMD_H', None)], 'include_dirs': ['X:\\inclib-vc9-x32\\umfpack', 'X:\\inclib-vc9-x32']}
