...
#define SBK_PHONON_QLIST_QVARIANT_IDX                                12 // const QList<QVariant > &
#define SBK_PHONON_QSET_QOBJECTPTR_IDX                               13 // QSet<QObject * >
#define SBK_PHONON_QPAIR_QBYTEARRAY_QSTRING_IDX                      14 // QPair<QByteArray, QString >
#define SBK_PHONON_QLIST_QPAIR_QBYTEARRAY_QSTRING_IDX                15 // QList<QPair<QByteArray, QString > >
...
#define SBK_PHONON_QLIST_PHONON_EFFECTPARAMETER_IDX                  18 // QList<Phonon::EffectParameter >
#define SBK_PHONON_QLIST_PHONON_EFFECTPTR_IDX                        19 // QList<Phonon::Effect * >
#define SBK_PHONON_QLIST_PHONON_PATH_IDX                             20 // QList<Phonon::Path >
