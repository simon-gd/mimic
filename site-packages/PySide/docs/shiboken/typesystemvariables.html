...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>5. Type System Variables &mdash; Shiboken 1.2.1 documentation</title>
...
<div class="header">
    ...
    <div class="related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="projectfile.html" title="4. Binding Project File"
...
<a class="reference internal" href="codeinjectionsemantics.html"><em>inject-code</em></a> tag. To ease the binding developer
...
<blockquote>
<div><p>Replaced by the name of a C++ argument in the position indicated by <tt class="docutils literal"><span class="pre">#</span></tt>.
The argument counting starts with <tt class="docutils literal"><span class="pre">%1</span></tt>, since <tt class="docutils literal"><span class="pre">%0</span></tt> represents the return
...
<blockquote>
<div><div class="highlight-c++"><div class="highlight"><pre><span class="kt">void</span> <span class="nf">argRemoval</span><span class="p">(</span><span class="kt">int</span> <span class="n">a0</span><span class="p">,</span> <span class="kt">int</span> <span class="n">a1</span> <span class="o">=</span> <span class="mi">123</span><span class="p">);</span>
</pre></div>
</div>
<div class="highlight-xml"><div class="highlight"><pre><span class="nt">&lt;modify-function</span> <span class="na">signature=</span><span class="s">&quot;argRemoval(int, int)&quot;</span><span class="nt">&gt;</span>
...
<p>The <tt class="docutils literal"><span class="pre">%1</span></tt> will be replaced by the C++ argument name, and <tt class="docutils literal"><span class="pre">%2</span></tt> will get the
value <tt class="docutils literal"><span class="pre">123</span></tt>.</p>
</div></blockquote>
...
<blockquote>
<div><div class="highlight-c++"><div class="highlight"><pre><span class="kt">void</span> <span class="nf">argRemoval</span><span class="p">(</span><span class="kt">int</span> <span class="n">a0</span><span class="p">,</span> <span class="n">Point</span> <span class="n">a1</span> <span class="o">=</span> <span class="n">Point</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">),</span> <span class="kt">bool</span> <span class="n">a2</span> <span class="o">=</span> <span class="nb">true</span><span class="p">,</span> <span class="n">Point</span> <span class="n">a3</span> <span class="o">=</span> <span class="n">Point</span><span class="p">(</span><span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">),</span> <span class="kt">int</span> <span class="n">a4</span> <span class="o">=</span> <span class="mi">56</span><span class="p">);</span>
</pre></div>
</div>
<div class="highlight-xml"><div class="highlight"><pre><span class="nt">&lt;modify-function</span> <span class="na">signature=</span><span class="s">&quot;argRemoval(int, Point, bool, Point, int)&quot;</span><span class="nt">&gt;</span>
    <span class="nt">&lt;modify-argument</span> <span class="na">index=</span><span class="s">&quot;2&quot;</span><span class="nt">&gt;</span>
        <span class="nt">&lt;remove-argument/&gt;</span>
...
<p>As seen on the XML description, the function&#8217;s <tt class="docutils literal"><span class="pre">a1</span></tt> and <tt class="docutils literal"><span class="pre">a3</span></tt> arguments
were removed. If any <tt class="docutils literal"><span class="pre">inject-code</span></tt> for this function uses <tt class="docutils literal"><span class="pre">%ARGUMENT_NAMES</span></tt>
the resulting list will be the equivalent of using individual argument type
system variables this way:</p>
<blockquote>
<div><div class="highlight-c++"><div class="highlight"><pre><span class="o">%</span><span class="mi">1</span><span class="p">,</span> <span class="n">Point</span><span class="p">(</span><span class="mi">6</span><span class="p">,</span> <span class="mi">9</span><span class="p">),</span> <span class="o">%</span><span class="mi">3</span><span class="p">,</span> <span class="n">Point</span><span class="p">(</span><span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">),</span> <span class="o">%</span><span class="mi">5</span>
</pre></div>
</div>
</div></blockquote>
</div></blockquote>
...
<blockquote>
<div><p>Replaced by the type of a C++ argument in the position indicated by <tt class="docutils literal"><span class="pre">#</span></tt>.
The argument counting starts with <tt class="docutils literal"><span class="pre">%1</span></tt>, since <tt class="docutils literal"><span class="pre">%0</span></tt> represents the return
variable in other contexts, but <tt class="docutils literal"><span class="pre">%ARG0_TYPE</span></tt> will not translate to the
return type, as this is already done by the
<a class="reference internal" href="#return-type"><em>%RETURN_TYPE</em></a> variable.
Example:</p>
<blockquote>
<div><div class="highlight-c++"><div class="highlight"><pre><span class="kt">void</span> <span class="nf">argRemoval</span><span class="p">(</span><span class="kt">int</span> <span class="n">a0</span><span class="p">,</span> <span class="kt">int</span> <span class="n">a1</span> <span class="o">=</span> <span class="mi">123</span><span class="p">);</span>
</pre></div>
...
to a C++ variable of the type indicated by <tt class="docutils literal"><span class="pre">CPPTYPE</span></tt>.</div></blockquote>
...
type indicated by <tt class="docutils literal"><span class="pre">CPPTYPE</span></tt> to the proper Python object.</div></blockquote>
...
if of the type indicated by <tt class="docutils literal"><span class="pre">CPPTYPE</span></tt>.</div></blockquote>
...
work on class level code injections also. Notice that <tt class="docutils literal"><span class="pre">CPPTYPE</span></tt> differs from
the <a class="reference internal" href="#type"><em>%TYPE</em></a> variable, for this latter may be translated to the original
C++ class name or to the C++ wrapper class name.</p>
<p>Namespaces will are treated as classes, so <tt class="docutils literal"><span class="pre">CPPTYPE</span></tt> will work for them and their
...
<blockquote>
<div><p>Similar to <tt class="docutils literal"><span class="pre">%#</span></tt>, but is replaced by the Python arguments (PyObjects)
received by the Python wrapper method.</p>
<p>If used in the context of a native code injection, i.e. in a virtual method
override, <tt class="docutils literal"><span class="pre">%PYARG_#</span></tt> will be translated to one item of the Python tuple
holding the arguments that should be passed to the Python override for this
virtual method.</p>
<p>The example</p>
<blockquote>
<div><div class="highlight-c++"><div class="highlight"><pre><span class="kt">long</span> <span class="n">a</span> <span class="o">=</span> <span class="n">PyInt_AS_LONG</span><span class="p">(</span><span class="o">%</span><span class="n">PYARG_1</span><span class="p">);</span>
</pre></div>
</div>
</div></blockquote>
<p>is equivalent of</p>
<blockquote>
<div><div class="highlight-c++"><div class="highlight"><pre><span class="kt">long</span> <span class="n">a</span> <span class="o">=</span> <span class="n">PyInt_AS_LONG</span><span class="p">(</span><span class="n">PyTuple_GET_ITEM</span><span class="p">(</span><span class="o">%</span><span class="n">PYTHON_ARGUMENTS</span><span class="p">,</span> <span class="mi">0</span><span class="p">));</span>
</pre></div>
</div>
</div></blockquote>
...
<p>This example</p>
<blockquote>
<div><div class="highlight-c++"><div class="highlight"><pre><span class="n">Py_DECREF</span><span class="p">(</span><span class="o">%</span><span class="n">PYARG_1</span><span class="p">);</span>
...
<p>is equivalent of</p>
<blockquote>
<div><div class="highlight-c++"><div class="highlight"><pre><span class="n">Py_DECREF</span><span class="p">(</span><span class="n">PyTuple_GET_ITEM</span><span class="p">(</span><span class="o">%</span><span class="n">PYTHON_ARGUMENTS</span><span class="p">,</span> <span class="mi">0</span><span class="p">));</span>
...
<blockquote>
<div>This variable is used only on <a class="reference internal" href="codeinjectionsemantics.html#codeinjecting-method-native"><em>native method code injections</em></a>, i.e. on the binding overrides for C++ virtual
...
Must match with a <a class="reference internal" href="#endallowthreads"><em>%END_ALLOW_THREADS</em></a> variable.</div></blockquote>
<p id="endallowthreads"><strong>%END_ALLOW_THREADS</strong></p>
<blockquote>
<div>Replaced by a thread state restoring procedure.
Must match with a <a class="reference internal" href="#beginallowthreads"><em>%BEGIN_ALLOW_THREADS</em></a> variable.</div></blockquote>
...
test. It changes a method that received <tt class="docutils literal"><span class="pre">argc/argv</span></tt> arguments into something
that expects a Python sequence instead.</p>
<blockquote>
<div><div class="highlight-xml"><div class="highlight"><pre><span class="nt">&lt;modify-function</span> <span class="na">signature=</span><span class="s">&quot;overloadedMethod(int, char**)&quot;</span><span class="nt">&gt;</span>
