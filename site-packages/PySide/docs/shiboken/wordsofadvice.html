...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>10. Words of Advice &mdash; Shiboken 1.2.1 documentation</title>
    ...
    <link rel="next" title="11. Shiboken module" href="shibokenmodule.html" />
    <link rel="prev" title="9. Object ownership" href="ownership.html" /> 
  </head>
  <body>
<div id="container">
<div class="header">
    ...
    <div class="related">
      ...
      <ul>
        <li class="right" style="margin-right: 10px">
          <a href="shibokenmodule.html" title="11. Shiboken module"
  ...
  <ul>
<li><a class="reference internal" href="#">10. Words of Advice</a><ul>
<li><a class="reference internal" href="#duck-punching-and-virtual-methods">10.1. Duck punching and virtual methods</a></li>
<li><a class="reference internal" href="#python-old-style-classes-and-pyside">10.2. Python old style classes and PySide</a></li>
</ul>
</li>
</ul>
  ...
  <p class="topless"><a href="ownership.html"
                        title="previous chapter">9. Object ownership</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="shibokenmodule.html"
                        title="next chapter">11. Shiboken module</a></p>
...
<span id="id1"></span><h1>10. Words of Advice<a class="headerlink" href="#words-of-advice" title="Permalink to this headline">¶</a></h1>
...
<span id="id2"></span><h2>10.1. Duck punching and virtual methods<a class="headerlink" href="#duck-punching-and-virtual-methods" title="Permalink to this headline">¶</a></h2>
...
<blockquote>
<div><div class="highlight-python"><div class="highlight"><pre><span class="kn">import</span> <span class="nn">types</span>
...
<span class="c"># CppClass has a virtual method called &#39;virtualMethod&#39;,</span>
<span class="c"># but we don&#39;t like it anymore.</span>
...
<span class="c"># Punching a dead duck...</span>
<span class="n">obj</span><span class="o">.</span><span class="n">virtualMethod</span> <span class="o">=</span> <span class="n">types</span><span class="o">.</span><span class="n">MethodType</span><span class="p">(</span><span class="n">myVirtualMethod</span><span class="p">,</span> <span class="n">obj</span><span class="p">,</span> <span class="n">Binding</span><span class="o">.</span><span class="n">CppClass</span><span class="p">)</span>
</pre></div>
</div>
</div></blockquote>
...
<span id="pyside-old-style-class"></span><h2>10.2. Python old style classes and PySide<a class="headerlink" href="#python-old-style-classes-and-pyside" title="Permalink to this headline">¶</a></h2>
<p>Because of some architectural decisions and deprecated Python types. Since PySide 1.1 old style classes are not supported with multiple inheritance.</p>
<p>Below you can check the examples:</p>
<p>Example with old style class:</p>
<blockquote>
<div><div class="highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">PySide</span> <span class="kn">import</span> <span class="n">QtCore</span>
...
<p>this example will raise a &#8216;TypeError&#8217; due to the limitation on PySide, to fix this you will need use the new style class:</p>
<blockquote>
<div><div class="highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">PySide</span> <span class="kn">import</span> <span class="n">QtCore</span>
...
<p>All classes used for multiple inheritance with other PySide types need to have &#8216;object&#8217; as base class.</p>
</div>
</div>
