...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>9. Object ownership &mdash; Shiboken 1.2.1 documentation</title>
...
<a class="reference internal" href="#ownership-virt-method"><em>virtual destructor</em></a> or the transfer is due to the special case
of <a class="reference internal" href="#ownership-parent"><em>parent ownership</em></a>.</p>
...
<p>To activate this heuristic, use the <a class="reference internal" href="commandlineoptions.html#parent-heuristic"><em>&#8211;enable-parent-ctor-heuristic</em></a>
...
was called.</p>
<p>To activate this heuristic, use the <a class="reference internal" href="commandlineoptions.html#return-heuristic"><em>&#8211;enable-return-value-heuristic</em></a></p>
</div></blockquote>
</div>
</div>
...
<div class="highlight-python"><div class="highlight"><pre><span class="n">renderer</span><span class="o">.</span><span class="n">setModel</span><span class="p">(</span><span class="n">Source</span><span class="p">())</span>
...
<div class="highlight-python"><div class="highlight"><pre><span class="n">source</span> <span class="o">=</span> <span class="n">Source</span><span class="p">()</span>
