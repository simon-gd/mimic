...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>8. Sequence Protocol &mdash; Shiboken 1.2.1 documentation</title>
...
<p>A concrete exemple how to add sequence protocol support to a class can be found on shiboken tests, more precisely in the definition of the Str class in <tt class="docutils literal"><span class="pre">tests/samplebinding/typesystem_sample.xml</span></tt>.</p>
</div>
